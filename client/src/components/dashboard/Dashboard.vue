...
export default {
  ...
  methods: {
          ...
          .then(res => {
            if (res.data.status === true) {
              this.$swal({
                ...
                icon: "success",
                toast: true,
                title: "Tarefa concluida comsucesso",
          ...
          .then(res => {
            if (res.data.status === true) {
              ...
              this.$swal({
                ...
                icon: "error",
                toast: true,
                title: "Ocorreu um erro ao tentar clonar",
                showConfirmButton: false,
                timer: 1500
              });
            }
        ...
        .then(res => {
          if (res.data.status === true) {
            ...
            this.$swal({
              ...
              icon: "error",
              toast: true,
              title: "Ocorreu um erro ao criar coluna :(",
              showConfirmButton: false,
              timer: 1500
            });
          }
        ...
        .catch(err => {
          if (err.response.status === 401) {
            ...
            this.$swal({
              ...
              icon: "error",
              toast: true,
              title: "Ocorreu um erro ao criar uma coluna :(",
              showConfirmButton: false,
              timer: 500
            });
          }
          ...
          .then(res => {
            if (res.data.status === true) {
              ...
              this.$swal({
                ...
                icon: "error",
                toast: true,
                title: "Ocorrer um erro ao criar coluna :(",
                showConfirmButton: false,
                timer: 1500
              });
            }
          ...
          .then(res => {
            if (res.data.status === true) {
              this.$swal({
                ...
                icon: "success",
                toast: true,
                title: "Coluna clonada com sucesso",
                showConfirmButton: false,
                timer: 1500
              });
            } else {
              this.$swal({
                ...
                icon: "error",
                toast: true,
                title: "Ocorreu um erro ao clonar coluna :(",
                showConfirmButton: false,
                timer: 1500
              });
            }
    ...
    createProject() {
      this.$swal({
        title: "Tens certeza ?",
        text: "Tem certeza que quer criar um novo projeto sensacional ?",
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
        confirmButtonText: "Sim ! Vamo nessa ! :)"
      }).then(result => {
        if (result.value) {
          this.$http
            .post("/user/projects", {
            ...
            .then(res => {
              if (res.data.status === true) {
                ...
                this.$swal({
                  ...
                  icon: "error",
                  toast: true,
                  title: "Ocorreu um erro ao criar projeto",
                  showConfirmButton: false,
                  timer: 1500
                });
              }
            ...
            .catch(err => {
              if (err.response.status === 401) {
                ...
                this.$swal({
                  ...
                  icon: "error",
                  toast: true,
                  title: "Ocorreu um erro ao criar um projeto",
                  showConfirmButton: false,
                  timer: 2000
                });
              }
